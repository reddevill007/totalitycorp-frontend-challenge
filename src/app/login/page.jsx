            ...
            <div className="min-h-screen bg-gray-100 text-gray-900 flex justify-center">
                <div className="w-full flex justify-center flex-1">
                    <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12 h-full">
                        <div className="flex flex-col items-center h-full justify-center">
                            <div className='space-y-4'>
                                <div className='mb-10'>
                                    <img className='h-24 w-full object-cover' src="/logo.png" alt="logo" />
                                </div>
                    ...
                    <div className="flex-1 bg-indigo-100 text-center hidden lg:flex">
                        <div className="m-12 xl:m-16 w-full bg-contain bg-center bg-no-repeat" style={{ backgroundImage: BG_IMG }} >
                        </div>
                    </div>
                </div>
            </div>
