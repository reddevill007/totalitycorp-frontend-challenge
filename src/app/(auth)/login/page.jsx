...
const Login = () => {
    ...
    return (
        <div className='h-screen w-full flex items-center justify-center flex-col'>
            ...
            <p class="text-center text-sm text-gray-500 font-light mt-4">Or sign up with credentials</p>
            <form className="mt-6 w-1/2" onSubmit={handleSubmit}>
                ...
                <div className="mt-4 flex items-center text-gray-500">
                    ...
                    <label className="text-sm" for="remember">I agree with the <a className="text-indigo-400 hover:text-indigo-500">Privacy Policy</a></label>
                </div>
                <Link href="/register">Deont have a account register</Link>
